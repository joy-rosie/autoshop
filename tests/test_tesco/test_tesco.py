...
@pytest.mark.parametrize("args, kwargs, expected", [
    ...
    (
        [],
        dict(description="Tesco Reduced Sugar And Salt Baked Beans In Tomato Sauce 420G"),
    ...
    (
        [],
        dict(description="Organix 5 Sunshine Veggies with Red Lentils Organic Baby Food 190g"),
    ...
    (
        [],
        dict(description="Tesco Apple & Raspberry No Added Sugar Sparkling Water 4X500ml"),
